...
const Index = () => {
  ...
  const [cookieStands, setCookieStands] = useState([]);
    ...
    const handleCreateCookieStand = (newCookieStand) => {
      axios.post('https://salmoncookie-api20231011183117.azurewebsites.net/api/CookieStands', newCookieStand)
        .then((response) => {
    ...
    const handleDeleteCookieStand = (id) => {
      axios.delete(`https://salmoncookie-api20231011183117.azurewebsites.net/api/CookieStands/${id}`)
        .then(() => {
    ...
    const fetchData = () => {
      ...
      axios
        .get('https://salmoncookie-api20231011183117.azurewebsites.net/api/CookieStands')
        .then((response) => {
